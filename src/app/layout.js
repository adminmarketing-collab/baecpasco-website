...
export const metadata = {
  title: "Balagot & Emperado CPA's Co.",
};
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="./img/logo-1.png" />

        <title>Balagot & Emperado CPA's Co.</title>
        <meta name="description" content="Balagot & Emperado CPA's Co."/>
      </head>
