...
import bgimg from "../../public/img/banner/testimonial.png";
...
const BreadcrumbTestimonial = ({ title }) => {
  return (
    <>
      <div
        ...
        {/* <div className="container">
          <div className="flex flex-wrap mx-[-12px]">
            <div className="w-full px-[12px] flex-[0_0_auto]">
              <h2 className="uppercase mb-[10px] font-medium text-[70px] text-red-500">
                {title}
              </h2>
...
export default BreadcrumbTestimonial;
