          ...
          <div className="xl:w-8/12 lg:w-8/12 md:w-7/12 sm:w-full xl:pr-[30px] lg:pr-[30px] md:pr-[30px] px-[12px]">
            <div className="merox-blog-details-wraper">
              <div className="blog-details-content">
                ...
                <blockquote className="block-quote bg-white border-l-[6px] border-solid border-[#f90908] !p-[35px] shadow-[0px_0px_30px_0px_rgba(26,43,60,0.15)] rounded-md relative overflow-hidden my-10 mx-0 z-[1] before:content-['\f10d'] before:absolute before:top-2/4 before:left-2/4 before:-translate-x-2/4 before:-translate-y-2/4 before:text-[#f90908] before:leading-none before:font-fontawesome before:text-[150px] before:opacity-[0.1] before:-z-[1]">
                  <p className="text-[#1a2b3c] text-[24px] font-medium leading-8">{BlogdetailsData.blockquote}</p>
                  <cite className="relative text-[16px] font-semibold capitalize pl-[15px] block mt-[30px] before:absolute before:content-[''] before:bottom-0 before:bg-[#f90908] before:top-2/4 before:left-0 before:w-[10px] before:h-[2px] before:my-0 before:mx-auto before:-translate-y-2/4">{BlogdetailsData.blockquoteauthor}</cite>
                </blockquote>
              ...
              <div className="blog-post-tag bg-white pt-[30px] pb-0 w-full overflow-hidden">
                ...
                <Link className="text-[#1a2b3c] inline-block font-medium uppercase duration-[0.3s] text-xs border-[1px] border-solid border-[#e5e5e5] py-[10px] px-6 mr-[5px] rounded-[30px] mb-[10px] hover:text-white hover:bg-[#f90908] hover:border-[#f90908]" href={item.link} key={i}>{item.title}</Link>
                ))}
              </div>
