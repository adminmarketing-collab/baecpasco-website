...
import aboutimg1 from "../../public/img/team/1.png"
          ...
          <div className="flex flex-wrap mx-[-12px]">
            ...
            <div className="xl:ml-[8.33333333%] xl:w-6/12 lg:w-6/12 md:w-full sm:w-full xsm:w-full px-[12px] wow fadeInRight">
              <div className="section-title mb-10 md:mt-10 sm:mt-10">
                ...
                <h3 className="text-[50px] font-bold leading-[49px] uppercase">Al Batara Balagot, CPA, MBA</h3>
              </div>
              <div className="about-content">
                ...
                <p><span className={`text-[#f90908]  fa fa-map-marker mr-2`}></span>Address: 2F GDCI Building, F. Torres St., Davao City, 8000
                </p>

                <br/>
                <p><span className={`text-[#f90908]  fa fa-mobile mr-2`}></span> Mobile: 09175899307</p>
                <p><span className={`text-[#f90908]  fa fa-phone mr-2`}></span> Landline: 082 308-1129</p>
                <p><span className={`text-[#f90908]  fa fa-envelope-o mr-2`}></span> Email: al.balagot@baecpasco.com</p>
                ...
                <br/>
              <h1 className='mb-10 text-2xl'> <span className='fa fa-id-card-o text-[#f90908]'></span> Contact for tax consultations, financial planning, and compliance auditing.</h1>
