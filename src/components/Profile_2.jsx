...
import aboutimg1 from "../../public/img/team/2.png"
...
const AboutData = {
  ...
  AboutList: [
    {
      title: "Audit & Assurance services, including Financial Statement Audits & Compliance Audits.",
    },
    {
      title: "High-level Business & Financial Consultancy, including risk management and corporate governance advisory.",
    },
    {
      title: "Regulatory Compliance & Corporate Services, including business registration and licensing assistance.",
    },
  ],
}
          ...
          <div className="flex flex-wrap mx-[-12px]">
            ...
            <div className="xl:ml-[8.33333333%] xl:w-6/12 lg:w-6/12 md:w-full sm:w-full xsm:w-full px-[12px] wow fadeInRight">
              <div className="section-title mb-10 md:mt-10 sm:mt-10">
                ...
                <h3 className="text-[50px] font-bold leading-[49px] uppercase">Rezyl Mae Emperado-Tero, CPA, MBA</h3>
              </div>
              <div className="about-content">
                <p><span className={`text-[#f90908]  fa fa-bookmark mr-2`}></span>Managing Partner</p>
                <p><span className={`text-[#f90908]  fa fa-map-pin mr-2`}></span> Midsayap Corporate Office</p>
                <p><span className={`text-[#f90908]  fa fa-map-marker mr-2`}></span> 2F Triple A Building, Poblacion 2, Midsayap, Cotabato, 9410
                </p>

                <br/>
                <p><span className={`text-[#f90908]  fa fa-mobile mr-2`}></span> Mobile:  0954-341-3680</p>
                <p><span className={`text-[#f90908]  fa fa-phone mr-2`}></span> Landline: 064-577-7725</p>
                <p><span className={`text-[#f90908]  fa fa-envelope-o mr-2`}></span> Email: rezyl.tero@baecpasco.com</p>
                ...
                <br/>
              <h1 className='mb-10 text-2xl'> <span className='fa fa-id-card-o text-[#f90908]'></span> Contact for corporate partnerships, regulatory concerns, and financial advisory.</h1>
