...
<h2 className="text-4xl font-bold text-white text-center mb-12">
  ...
  <h4 className="font-semibold text-lg mb-2 text-gray-600 mb-2 pl-12">Core Bookkeeping Functions:</h4>
    <ul className="list-disc pl-5 space-y-2 text-gray-600 pl-28">
  ...
  <ServiceAccordion title="Payroll Services">
    ...
    <h4 className="font-semibold text-lg mb-2 text-gray-600 mb-2 pl-12">Payroll Management Services:</h4>
    <ul className="list-disc pl-5 space-y-2 text-gray-600 pl-28">
