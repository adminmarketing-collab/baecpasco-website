...
<h2 className="text-4xl font-bold text-white text-center mb-12">
  ...
  <p className="text-white text-lg leading-relaxed pb-4">
  ...
  <div>
    ...
    <ul className="list-disc list-outside pl-20 space-y-2 text-gray-600">
  ...
  <div>
    <h4 className="font-semibold text-lg mb-2 text-lg mb-2 pl-6">Bookkeeping Services</h4>
    <p className="text-gray-600 mb-3 pl-6">
  ...
  <h4 className="font-semibold text-lg mb-2 list-disc list-outside pl-12 space-y-2 text-gray-600">Core Bookkeeping Functions:</h4>
    <ul className="list-disc list-outside pl-24 space-y-2 text-gray-600">
  ...
  <p className="text-gray-600 mt-3 mb-3 pl-12">
  ...
  <ServiceAccordion title="Payroll Services">
    ...
    <h4 className="font-semibold text-lg mb-2 list-disc list-outside pl-12 space-y-2 text-gray-600">Payroll Management Services:</h4>
    <ul className="list-disc list-outside pl-24 space-y-2 text-gray-600">
...
<ServiceAccordion title="Business Advisory & Financial Consultancy">
  ...
  <div className="space-y-6">
    <div>
      <h4 className="font-semibold text-lg mb-2 text-lg mb-2 pl-6">
       Strategic Planning
      </h4>
      <p className="text-gray-600 mb-3 pl-6">
