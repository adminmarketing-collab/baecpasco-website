...
export default function Services() {
  return (
    <section className="bg-[#24262d] py-12 md:py-16">
  <div className="mx-auto max-w-5xl space-y-4 px-4 sm:px-6 lg:px-8">

<h2 className="mb-10 text-center text-3xl font-bold text-white md:mb-12 md:text-4xl">
      Accounting Services in Mindanao
    </h2>

    <div className="mx-auto mb-12 max-w-3xl space-y-6 text-center">
  <p className="text-base leading-7 text-white md:text-lg md:leading-relaxed">
  ...
  <p className="pb-4 text-base leading-7 text-white md:text-lg md:leading-relaxed">
  ...
  <ServiceAccordion title="Audit & Assurance">
    ...
    <div>
      <h4 className="font-semibold text-lg mb-2 pl-6">Financial Statement Audits</h4>
    ...
    <div>
      <h3 className="font-semibold text-lg mb-2 pl-6">Internal Audit Services</h3>
      <p className="text-gray-600 mb-4 pl-6">
    ...
    <div>
      <h4 className="font-semibold text-lg mb-2 pl-6">Compliance Audits</h4>
      <p className="list-disc space-y-2 text-gray-600 pl-6">
    ...
    <div>
      <h4 className="font-semibold text-lg mb-2 pl-6">Review & Compilation Engagements</h4>
      <p className="list-disc space-y-2 text-gray-600 pl-6">
    ...
    <div>
      <h4 className="font-semibold text-lg mb-2 pl-6">Agreed Upon Procedures Engagements</h4>
      <p className="list-disc space-y-2 text-gray-600 pl-6">
    ...
    <div>
      <h4 className="font-semibold text-lg mb-2 pl-6">Specialized Assurance Services</h4>
      <p className="list-disc space-y-2 text-gray-600 pl-6">
  ...
  <div>
    ...
    <ul className="list-disc list-outside pl-12 md:pl-16 lg:pl-24 space-y-2 text-gray-600">
    ...
    <p className="text-gray-600 mt-3 mb-3 pl-6"> 
  ...
  {/* SUB CATEGORY 2 */}
  <div>
    <h4 className="font-semibold text-lg mb-2 pl-6">Financial Reporting</h4>
  ...
  <ServiceAccordion title="Taxation & Compliance">
    ...
    <p className="mb-4 text-gray-600">
     ...
     {/* SUB CATEGORY 1 */}
  <div>
    <h4 className="font-semibold text-lg mb-2 pl-6">Tax Compliance Services</h4>
  ...
  {/* SUB CATEGORY 2 */}
  <div>
    <h4 className="font-semibold text-lg mb-2 pl-6">Regulatory Compliance Services</h4>
    <p className="text-gray-600 mb-3 pl-6">
  ...
  <ServiceAccordion title="Bookkeeping Services">
  ...
  <div>
    <h4 className="font-semibold text-lg mb-2 pl-6">Bookkeeping Services</h4>
    <p className="text-gray-600 mb-3 pl-6">
     ...
     <p className="mb-4 text-gray-600 pl-6">
  ...
  <h4 className="font-semibold text-lg mb-2 list-disc list-outside pl-6 md:pl-8 lg:pl-12 space-y-2 text-gray-600">Core Bookkeeping Functions:</h4>
    <ul className="list-disc list-outside pl-14 md:pl-18 lg:pl-28 space-y-2 text-gray-600">
  ...
  <p className="text-gray-600 mt-3 mb-3 pl-6 md:pl-8 lg:pl-12">
  ...
  <ServiceAccordion title="Payroll Services">
    <p className="mb-6 text-gray-600">
    ...
    <h4 className="font-semibold text-lg mb-2 list-disc list-outside pl-6 md:pl-8 lg:pl-12 space-y-2 text-gray-600">Payroll Management Services:</h4>
    <ul className="list-disc list-outside pl-14 md:pl-18 lg:pl-28 space-y-2 text-gray-600">
...
<ServiceAccordion title="Business Advisory & Financial Consultancy">
  ...
  <div className="space-y-6">
    <div>
      <h4 className="font-semibold text-lg mb-2 pl-6">
       Strategic Planning
      </h4>
      <p className="text-gray-600 mb-3 pl-6">
  ...
  <div className="space-y-6">
    <div>
      <h4 className="font-semibold text-lg mb-2 text-lg mt-4 mb-2 pl-6">
