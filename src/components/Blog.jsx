...
import ArticlesData from '../jsonData/ArticlesData.json';
  ...
  BlogList: [
    {
      img: img1,
      date: "14 NOV 2019",
      posttitle: "Stay Updated: BIR Extends Deadline for Digital VAT Registration",
      postlink: "#",
      brief:
  ...
  return (
    <>
      ...
      >
        ...
        <div className="container">
          <div className="flex flex-wrap mx-[-12px]">
            {ArticlesData.BlogList.map((item, i) => (
              <div
