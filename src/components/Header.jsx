...
const Header = () => {
  ...
  return (
    <>
      <header>
        <div
          className={`bg-[#0000004d] header-area absolute left-0 right-0 top-0 z-10 border-b-[1px] border-solid border-[#cacaca] transition-all duration-[0.3s] ${
            sticky ? "header-fixed animated slideInDown" : ""
          }`}
        >
          <div className="container">
            <div className="flex flex-wrap mx-[-12px] relative">
              <div className="xl:w-40 lg:w-2/12 md:w-3/12 sm:w-3/12 xsm:w-3/12 px-[12px] flex-[0_0_auto]">
              ...
              <div className="xl:w-10/12 lg:w-10/12 md:w-9/12 sm:w-9/12 xsm:w-9/12 px-[12px] flex-[0_0_auto]">
                <div className="header-top-right float-right xl:pr-0 lg:pr-[70px] md:pr-[70px] sm:pr-[50px]">
                  ...
                  >
                    <li className="list-none p-0 m-0">
                      <div
                        className="text-white text-center block p-9 bg-[#0000004d] hover:text-[#f90908] cursor-pointer"
                        href="#"
                      >
                ...
                <div className="main-menu-area text-center md:hidden sm:hidden">
        ...
        >
          <div className="search-form-centered bg-transparent border-none text-white p-[10px_15px] w-6/12 align-middle inline-block">
            <div id="search-box" className="relative w-full m-0">
              <i
                id="close-btn"
                className="fa fa-times fa-2x fixed top-4 right-4 hover:text-[#f90908] hover:cursor-pointer"
              ...
              <form className="search-form">
                ...
                <button
                  type="submit"
                  className="bg-[#f90908] absolute top-[10px] right-[10px] text-center leading-[42px] border-x-0 rounded-none cursor-pointer py-[9px] px-[50px] text-white text-[18px] uppercase font-bold transition-all duration-[0.3s] hover:bg-[#24262d]"
                >
