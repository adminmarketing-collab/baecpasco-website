  ...
  const [isOpen, setOpen] = useState(false);
    ...
    useEffect(() => {
      ...
      fetch("https://adminmarketing-collab.github.io/becco-articles/news/news_1.json")
        ...
        fetch("https://adminmarketing-collab.github.io/becco-articles/news/news_2.json")
        .then((res) => res.json())
        .then((json) =>{
         setBlogData2(json);
        })
        ...
        fetch("https://adminmarketing-collab.github.io/becco-articles/news/news_3.json")
        .then((res) => res.json())
        .then((json) =>{
         setBlogData3(json);
        })
