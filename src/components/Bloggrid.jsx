  ...
  SimplepostList: [
    {
      ...
      date: "14 NOV 2019",
      posttitle:
        "Stay Updated: BIR Extends Deadline for Digital VAT Registration",
      postlink: "#",
      brief:
      ...
      <div id="merox-blog-area" className="merox-blog-area my-[100px]">
        <div className="container">
          <div className="flex flex-wrap mx-[-12px]">
            <div className="xl:w-6/12 lg:w-6/12 md:w-full sm:w-full xsm:w-full px-[12px] flex-[0_0_auto]">
