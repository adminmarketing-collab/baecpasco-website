...
import aboutimg1 from "../../public/img/team/6.png"
...
const AboutData = {
  ...
  AboutList: [
    {
      title: " Audit & Assurance Services, including Financial Statement Audits, Internal Audits, and Compliance Audits.",
    },
    {
      title: " Business & Financial Consultancy, including strategic financial planning and risk management.",
    },
    {
      title: " Regulatory Compliance & Corporate Services, including business registration and governance advisory.",
    },
  ],
}
          ...
          <div className="flex flex-wrap mx-[-12px]">
            ...
            <div className="xl:ml-[8.33333333%] xl:w-6/12 lg:w-6/12 md:w-full sm:w-full xsm:w-full px-[12px] wow fadeInRight">
              <div className="section-title mb-10 md:mt-10 sm:mt-10">
                ...
                <h3 className="text-[50px] font-bold leading-[49px] uppercase">Von Zerick M. Casero, CPA, CTT</h3>
              </div>
              <div className="about-content">
                <p><span className={`text-[#f90908]  fa fa-bookmark mr-2`}></span>Branch Manager - Partner</p>
                <p><span className={`text-[#f90908]  fa fa-map-pin mr-2`}></span>Koronadal Corporate Office</p>
                <p><span className={`text-[#f90908]  fa fa-map-marker mr-2`}></span> Address: MB BLDG., Upper Balmores St., Brgy. GPS, Koronadal City, South Cotabato, 9506</p>

                <br/>
                <p><span className={`text-[#f90908]  fa fa-mobile mr-2`}></span> Mobile: 09633235093</p>
                <p><span className={`text-[#f90908]  fa fa-phone mr-2`}></span> Landline: 083-823-5687</p>
                <p><span className={`text-[#f90908]  fa fa-envelope-o mr-2`}></span> Email:  von.casero@baecpasco.com</p>
                ...
                <br/>
              <h1 className='mb-10 text-2xl'> <span className='fa fa-id-card-o text-[#f90908]'></span> Contact for audit inquiries, corporate compliance, and business consultancy.</h1>
