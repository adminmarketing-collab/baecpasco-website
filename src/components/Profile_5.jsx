...
import aboutimg1 from "../../public/img/team/5.png"
...
const AboutData = {
  ...
  AboutList: [
    {
      title: "Tax Planning & Advisory, including business tax optimization and risk assessment.",
    },
    {
      title: "Tax Return Preparation & Compliance, ensuring accurate filings and regulatory adherence.",
    },
    {
      title: "Tax Training & Workshops, providing updates on tax laws and compliance requirements.",
    },
  ],
}
          ...
          <div className="flex flex-wrap mx-[-12px]">
            ...
            <div className="xl:ml-[8.33333333%] xl:w-6/12 lg:w-6/12 md:w-full sm:w-full xsm:w-full px-[12px] wow fadeInRight">
              <div className="section-title mb-10 md:mt-10 sm:mt-10">
                ...
                <h3 className="text-[50px] font-bold leading-[49px] uppercase">Marissa Francisco-Casero, CPA, CTT</h3>
              </div>
              <div className="about-content">
                <p><span className={`text-[#f90908]  fa fa-bookmark mr-2`}></span>Tax Director - Partner</p>
                <p><span className={`text-[#f90908]  fa fa-map-pin mr-2`}></span>Kidapawan Corporate Office</p>
                <p><span className={`text-[#f90908]  fa fa-map-marker mr-2`}></span> Address: Purok 2, Brgy. Magsaysay, Kidapawan City, North Cotabato, 9400</p>

                <br/>
                <p><span className={`text-[#f90908]  fa fa-mobile mr-2`}></span> Mobile: 0977-789-1060 |  0969-191-1862</p>
                <p><span className={`text-[#f90908]  fa fa-phone mr-2`}></span> Landline: 064-572-7648</p>
                <p><span className={`text-[#f90908]  fa fa-envelope-o mr-2`}></span> Email: marissa.casero@baecpasco.com</p>
                ...
                <br/>
              <h1 className='mb-10 text-2xl'> <span className='fa fa-id-card-o text-[#f90908]'></span> Contact For tax-related concerns, compliance support, and advisory services.</h1>
