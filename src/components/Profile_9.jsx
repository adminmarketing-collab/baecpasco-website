...
import aboutimg1 from "../../public/img/team/9.png"
...
const AboutData = {
  ...
  AboutList: [
    {
      title: "Tax Return Preparation & Filing, ensuring accurate and timely submissions.",
    },
    {
      title: " Business Tax Compliance & Risk Management, assisting businesses in regulatory adherence.",
    },
    {
      title: "Tax Assessment Assistance, guiding clients through tax audits and assessments.",
    },
  ],
}
          ...
          <div className="flex flex-wrap mx-[-12px]">
            ...
            <div className="xl:ml-[8.33333333%] xl:w-6/12 lg:w-6/12 md:w-full sm:w-full xsm:w-full px-[12px] wow fadeInRight">
              <div className="section-title mb-10 md:mt-10 sm:mt-10">
                ...
                <h3 className="text-[50px] font-bold leading-[49px] uppercase">Wellore John S. Grado</h3>
              </div>
              <div className="about-content">
                <p><span className={`text-[#f90908]  fa fa-bookmark mr-2`}></span>Senior Tax Associate</p>
                ...
                <p><span className={`text-[#f90908]  fa fa-envelope-o mr-2`}></span> Email: wellore.grado@baecpasco.com</p>
                ...
                <br/>
              <h1 className='mb-10 text-2xl'> <span className='fa fa-id-card-o text-[#f90908]'></span> Contact for tax filing assistance, compliance support, and tax advisory.</h1>
