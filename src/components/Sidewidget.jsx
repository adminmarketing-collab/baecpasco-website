      ...
      <div className="xl:w-4/12 lg:w-4/12 md:w-5/12 sm:w-full xsm:w-full px-[12px] flex-[0_0_auto]">
        {/* <div className="single-sid-wdg p-[30px] mb-[50px] border-[1px] border-solid border-[#f1f1f1] sm:mt-[30px]">
          <form action="#" className="wdg-search-form relative">
            ...
            />
            <button
              className="submit-btn h-[57px] bg-[#f90908] border-[1px] border-solid border-[#f1f1f1] text-white text-[15px] font-semibold tracking-[1px] p-[15px_30px] inline-block rounded-none absolute right-0 top-0 cursor-pointer border-l-[#f7faff] focus:bg-[#f90908]"
              type="submit"
            >
        ...
        <div className="single-sid-wdg p-[30px] mb-[50px] border-[1px] border-solid border-[#f1f1f1]">
          <div className="widget_recent_entries">
            <h3 className="font-bold text-[#353858] mb-10 capitalize text-[24px] relative before:absolute before:left-0 before:content-[''] before:-bottom-[15px] before:w-[70px] before:h-1 before:bg-[#f90908]">
              {SidewdgData.title}
            </h3>
          ...
          <ul className="wdg-follow-us p-0 m-0">
            {SidewdgData.SocialList.map((item, i) => (
              <li className="inline-block my-0 mx-[5px]" key={i}>
                <Link
                  className="block text-center text-[20px] text-[#1a2b3c] bg-white rounded-[50%] leading-10 w-10 h-10 transition-all duration-[0.3s] border-[1px] border-solid border-[#f1f1f1] hover:text-white hover:bg-[#f90908] "
                  href={item.link}
                >
          ...
          <div className="widget_tag_cloud">
            ...
            <div className="tagcloud">
              {SidewdgData.TagsList.map((item, i) => (
                <Link
                  className="text-[13px] leading-6 text-[#1a2b3c] py-[10px] px-[15px] border-[1px] border-solid border-[#f1f1f1] inline-block transition-all duration-[0.2s] capitalize rounded-[20px] mt-0 mr-[5px] mb-[10px] ml-0 hover:bg-[#f90908] hover:text-white"
                  href={item.link}
                >
                  {item.title}
                </Link>
            ...
            <ul>
              {SidewdgData.CtgList.map((item, i) => (
                <li className="group last:mb-0" key={i}>
                  <Link
                    className="capitalize text-[16px] text-[#757575] transition-all duration-[0.3s] group-hover:text-[#f90908]"
                    href={item.link}
                  >
                    {item.title}
                  </Link>
