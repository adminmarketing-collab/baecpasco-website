...
const FooterData = {
  ...
  ContactinfoList: [
    ...
    },
    {
      ...
      title: "Email: balagotandemperadocpas@baecpasco.com",
    },
    {
      icon: "fa fa-envelope-o ",
                  ...
                  <div className="widget_recent_entries m-0 p-0 list-none">
                    ...
                    <ul>
                      {FooterData.RecentpostList.map((item, i) => (
                        ...
                        >
                          <Link
                            className="text-white text-[16px] block font-medium hover:text-[#f90908]"
                            href={item.link}
                          >
                            {item.title}
                          </Link>
                  ...
                  <div className="custom-html-widget">
                    ...
                    <ul className="contact-details m-0 p-0 list-none">
                      {FooterData.ContactinfoList.map((item, i) => (
                        <li
                          className="flex items-center font-medium capitalize  cursor-pointer leading-6 group"
                          key={i}
                        >
                          <div>
                            <i
                              className={`group-hover:!bg-[#f90908] group-hover:!text-white w-[30px] h-[30px] text-[14px] bg-white text-center text-[#f90908] !leading-[30px] rounded-[50%] float-left my-[10px] mr-[12px] ml-0 transition-all duration-[0.3s] ${item.icon}`}
                            ></i>
                          </div>
