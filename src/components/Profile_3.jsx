...
import aboutimg1 from "../../public/img/team/3.png"
...
const AboutData = {
  ...
  AboutList: [
    {
      title: " Taxation & Compliance – Tax Planning, Return Filing, Risk Management",
    },
    {
      title: "Business & Financial Consultancy – Financial Forecasting & Budgeting",
    },
    {
      title: " Audit & Assurance – Internal & Compliance Audits",
    },
  ],
}
          ...
          <div className="flex flex-wrap mx-[-12px]">
            ...
            <div className="xl:ml-[8.33333333%] xl:w-6/12 lg:w-6/12 md:w-full sm:w-full xsm:w-full px-[12px] wow fadeInRight">
              <div className="section-title mb-10 md:mt-10 sm:mt-10">
                ...
                <h3 className="text-[50px] font-bold leading-[49px] uppercase">Cherry Mae Castro-Orella, CPA, MBA</h3>
              </div>
              <div className="about-content">
                <p><span className={`text-[#f90908]  fa fa-bookmark mr-2`}></span>Managing Partner</p>
                <p><span className={`text-[#f90908]  fa fa-map-pin mr-2`}></span>4104 35A Street, Vernon, B.C, Canada</p>
                  <p><span className={`text-[#f90908]  fa fa-map-marker mr-2`}></span>Address: 4104 35A Street, Vernon, B.C, Canada</p>

                <br/>
                <p><span className={`text-[#f90908]  fa fa-mobile mr-2`}></span> Mobile: </p>
                <p><span className={`text-[#f90908]  fa fa-phone mr-2`}></span> Landline: +1 250 307 6829</p>
                <p><span className={`text-[#f90908]  fa fa-envelope-o mr-2`}></span> Email: : cherrymae.orella@baecpasco.com</p>
                ...
                <br/>
              <h1 className='mb-10 text-2xl'> <span className='fa fa-id-card-o text-[#f90908]'></span> Contact for tax strategy, business forecasting, and audit compliance.</h1>
